...
//		pobj.store(fout,"write data");
		...
		String username=pobj.getProperty("Retailerusername");
		String password=pobj.getProperty("Retailerpassword");
		String logindd=pobj.getProperty("Retailerlogin");
		String admintype=pobj.getProperty("Retailerlogintype");
